...
This script uses the 'Business Continuity - Employee Information.csv' that is emailed to
IT Governance every day. Make sure the script and the csv are in the same folder.
...
api_token = 'INSERT SAMANAGE API TOKEN BEFORE RUNNING'
